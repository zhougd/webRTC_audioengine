...
void GlobalRef::CallVoidMethod(jmethodID methodID, ...) {
  ...
  va_list args;
  va_start(args, methodID);
  ALOGD("CallVoidMethod: %d", methodID);
...
//void NativeRegistration::setCurrentJNI(JNIEnv* jni) {
//  jni_ex_ = jni;
  //JavaClass::setClassJNI(jni);
//}
...
//void JavaClass::setClassJNI(JNIEnv* jni) {
//  jni_ = jni;
//}
