...
class AudioTrackJni {
 public:
  ...
  class JavaAudioTrack {
   ...
   private:
    ...
    NativeRegistration* native_reg_;
  };
 ...
 private:
  ...
  rtc::PlatformThread track_thread_;
